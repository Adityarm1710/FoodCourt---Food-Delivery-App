export const RestaurantCard = (props) => {
  ...
  return (
    <div className="mr-2 mb-1 transition-transform duration-500 hover:scale-90 hover:shadow-xl hover:rounded-lg hover:bg-slate-50 rounded-md w-[320px] shadow-md">
